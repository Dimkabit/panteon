(() => {
    ...
    function initSliders() {
        if (document.querySelector(".galery-catcher__slider")) new core(".galery-catcher__slider", {
    ...
    function initSlider() {
        if (document.querySelector(".galery-galery__slider")) new core(".galery-galery__slider", {
            modules: [ Navigation, Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    function initTrainerSliders() {
        bildSliders();
        if (document.querySelector(".trainer-block-sliders__slider")) new core(".trainer-block-sliders__slider", {
            modules: [ Navigation, Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            spaceBetween: 15,
            scrollbar: {
                el: ".trainer-swiper-scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".trainer-swiper-button-prev",
                nextEl: ".trainer-swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
